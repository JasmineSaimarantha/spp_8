...
<div class="row">
    <div class="row">
        <a href="{{route('show-report')}}" class="btn float-left"><i class="fa-solid fa-receipt"></i>Print this page</a>
        <div class="col-md-12">
                       ...
                       <div class="border-top">
                          <div class="float-right">
                            ...
                            <div class="mt-4 text-uppercase">
                                ...
                                @endif --}}
                                <div>Tunggakan = Rp.<b class="text-capitalize">{{ $tunggakan = $spp - $bayar }}</b></div>
